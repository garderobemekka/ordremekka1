 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">VIDERE SEND TIL HENT/FRAKT/MONTØR</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <h2>MOTTATT AVDELING<br><font size="3px">(Mine ordrer som er mottatt avdeling)</font></h2>
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where selger = '".$firstname."' and (status = 'Mottatt Avdeling')  ORDER BY `datosendtprod` ASC";
            ...
            ?>
                        ...
                        <tbody>
                            ...
                            <td> <center><font size=3><a href="<?php echo $baseurl; ?>/ordreinfo.php?ordreinfo=<?php echo $row['ordrenr'] ?>"><?php echo $row['ordrenr']; ?> </a></center></td></div></font>
                                ...
                                <td><center><?php 
                                if(($row['leveringskode'] == 'HI') or ($row['leveringskode'] == 'HF') or ($row['leveringskode'] == 'HFI'))
                                        { echo "<button type='button' class='btn btn-info btn-sm'> <a href='henteordre.php'>HENTE </a> </button>"; }
                                else if(($row['leveringskode'] == 'FI') or ($row['leveringskode'] == 'FF') or ($row['leveringskode'] == 'FFI'))                              
                                        { echo "<button type='button' class='btn btn-info btn-sm'><a href='fraktordre.php'> FRAKT </a> </button>"; }
                                else if(($row['leveringskode'] == 'MI') or ($row['leveringskode'] == 'MF') or ($row['leveringskode'] == 'MFI'))                              
                                        { echo "<button type='button' class='btn btn-info btn-sm'> <a href='monteringsordre.php'>MONTER</a> </button>"; }
                                ?>
