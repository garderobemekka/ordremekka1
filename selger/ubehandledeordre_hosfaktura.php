...
$query = "SELECT * FROM ordre where (selger = '".$firstname."' and status = 'Sendt Forskudd Regnskap') or (selger = '".$firstname."' and status ='Forskudd Faktura Regnskap'";
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
            <h2>HOS REGNSKAP<br><font size="3px">(Ordrer som er sendt til Regnskap - Forskudd Faktura)</font></h2>
            </div>
                ...
                $query = "SELECT * FROM ordre where (selger = '".$firstname."' and status = 'Sendt Forskudd Regnskap') or (selger = '".$firstname."' and status = 'Forskudd Faktura Sendt') ORDER BY `datoopprettet` ASC";
            ...
            ?>
                  ...
                  echo '<td> <a href="'.$baseurl.'/ordremappe/'.$row['ordrenr'].'.pdf" target="new">Last ned</a></td>';
                                ...
                                <td> <center><?php echo $row['datosendtforskuddregnskap']; ?> </center></td>
