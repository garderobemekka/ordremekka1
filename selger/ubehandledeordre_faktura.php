    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_sendforskuddregnskap.php" method="POST">
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">      
        <h2>FORSKUDD FAKTURA ORDRER<br><font size="3px">(Ordrer som skal sendes til regnskap - Forskudd Faktura)</font></h2>
    </div>
   
   <?php
                include_once('../conn.php'); 

                $query = "SELECT * FROM ordre where selger = '".$firstname."' and (status = 'Forskudd Faktura')  ORDER BY `datoopprettet` ASC";
