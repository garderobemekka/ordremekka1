...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="card-body" align="right"></div>
            <div class="card">
            <h2>PÅ VENT I PRODUKSJON<br><font size="3px">(Ordrer som er satt "På Vent")</font></h2>
            </div>
            <div align="right">
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where selger = '".$firstname."' and (status = 'Satt På Vent')  ORDER BY `datosendtprod` ASC";
            ...
            ?>
                        ...
                        <tbody>
                            ...
                            <td> <center><font size=3><a href="<?php echo $baseurl; ?>/ordreinfo.php?ordreinfo=<?php echo $row['ordrenr'] ?>"><?php echo $row['ordrenr']; ?> </a></center></td></div></font>
                                ...
                                <td> <center><?php echo $row['datoendringstatus']; ?> </center></td>
