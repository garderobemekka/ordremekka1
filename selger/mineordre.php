...
$query = "SELECT * FROM ordre where selger = '".$firstname."'";
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="container-fluid">
            <h2>ALLE MINE ORDRER<br><font size="3px">(Alle mine ordrer uansett status)</font></h2>
            </div>
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where selger = '".$firstname."'  ORDER BY `datosendtprod` ASC";
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                                ...
                                <td><center><font size="3"> <?php echo $row['kundenr']; ?></center> </td></font>
                                ...
                                <td><center> <?php echo $row['avdeling']; ?> </center></td>
                                ...
                                <td><center><button type="button" class="btn btn-info btn-sm"><a href="ordreinfo.php?ordreinfo=<?php echo $row['ordrenr'] ?>"> Info </button></td></center>
