 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">VIDERESEND TIL MONTERINGSLEDER</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_sendtmonteringsleder.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="leveringskode" id="leveringskode" placeholder="Leveringskode" readonly>  
                            ...
                            <input type="text" name="status" value="Sendt til Monteringsleder" 	readonly>
                            <input type='text' value="<?php echo $date; ?>" id='datosendtmonteringsleder' name='datosendtmonteringsleder' readonly><br>
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <h2>MINE MONTERINGSORDRER<br><font size="3px">(Ordrer som skal merkes "Klar for montering")</font></h2>
            </div>
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'MF') or (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'MFI') or (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'MI')  ORDER BY `datosendtprod` ASC";
