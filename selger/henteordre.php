 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">SMS SENDT / KLAR FOR HENTING</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_henteordre.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="num" name="kundetelefon" id="kundetelefon" placeholder="Kunde Telefon" readonly>    <br>
                        ...
                        <input type="text" name="leveringskode" id="leveringskode" placeholder="Leveringskode" readonly>  
                            ...
                            <font color="red" size="small">OBS! Dette er en kvittering på at sms er sendt</font> 
                            <input type="text" name="status" value="Klar for Henting" 	readonly>
                            <input type='text' value="<?php echo $date; ?>" id='datoklarforhenting' name='datoklarforhenting' readonly><br>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h2>MINE HENTEORDRE<br><font size="3px">(Ordrer som skal merkes "Klare for henting")</font></h2>
            </div>
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'HF') or (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'HFI') or (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'HI')  ORDER BY `datosendtprod` ASC";
