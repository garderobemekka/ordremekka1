 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">VIDERESEND TIL TRANSPORT</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_sendttransport.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="leveringskode" id="leveringskode" placeholder="Leveringskode" readonly>  
                            ...
                            <input type="text" name="status" value="Sendt til Frakt" 	readonly>
                            <input type='text' value="<?php echo $date; ?>" id='datosendttransport' name='datosendttransport' readonly><br>
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
    <h2>MINE FRAKTORDRE<br><font size="3px">(Ordrer som skal merkes "Sendt til Transport")</font></h2>
            </div>
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'FF') or (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'FFI') or (selger = '".$firstname."' and status = 'Mottatt Avdeling' and leveringskode = 'FI')  ORDER BY `datosendtprod` ASC";
